...
// esta seria la funcion que en realidad escribe a STDOUT, manejada por el selector
...
// libera y reinicia los recursos relevantes al logger con la excepcion del FD duplicado y 
// el selector_unregister
